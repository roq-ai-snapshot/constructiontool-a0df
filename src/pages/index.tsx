...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Constructiontoolrental`}</title>

        <meta
          name="description"
          content="Constructiontoolrental: Your Ultimate Partner in Building Dreams. Streamline Your Construction Process with Our Easy-to-Use Rental Service. Let's Build Together."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb258ZW58MHx8fHwxNjk5OTU2Mzg5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Constructiontoolrental`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Constructiontoolrental: Your Ultimate Partner in Building Dreams. Streamline Your Construction Process with Our Easy-to-Use Rental Service. Let's Build Together.`}
            </Text>
            <Box
